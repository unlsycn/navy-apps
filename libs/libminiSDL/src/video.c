...
void SDL_UpdateRect(SDL_Surface *s, int x, int y, int w, int h)
{
    ...
    else
    {
        ...
        for (int i = 0; i < h; i++)
        {
            ...
            {
                int x_off = x + j;
                uint8_t a = colors[s->pixels[x_off + y_off]].a;
                uint8_t r = colors[s->pixels[x_off + y_off]].r;
                uint8_t g = colors[s->pixels[x_off + y_off]].g;
                uint8_t b = colors[s->pixels[x_off + y_off]].b;
...
SDL_Surface *SDL_CreateRGBSurface(uint32_t flags, int width, int height, int depth, uint32_t Rmask, uint32_t Gmask,
...
SDL_Surface *SDL_CreateRGBSurfaceFrom(void *pixels, int width, int height, int depth, int pitch, uint32_t Rmask, uint32_t Gmask,
                                      uint32_t Bmask, uint32_t Amask)
{
